...
export default function PlayAndEarn() {
  ...
  return (
    <div className="PlayAndEarn" id="playAndEarn_id">
      <h3 className="PlayAndEarn_title">
        <b>
          <svg
            viewBox="0 0 50 50"
            fill="none"
      ...
      <div className="PlayAndEarn_textImg">
        ...
        <div className="PlayAndEarn_scheme_w">
          <img className="img_logo" src={items[0]?.icon} alt="" />

          <img className="img_line1_1" src={line1} alt="" />
          <span className="img_line1_1_text">{items[0]?.text1}</span>

          <img className="img_line1_2" src={line1} alt="" />
          <span className="img_line1_2_text">{items[0]?.text2}</span>

          <img className="img_line2_1" src={line2} alt="" />
          <span className="img_line2_1_text">{items[0]?.text3}</span>

          <img className="img_line2_2" src={line2} alt="" />
          <span className="img_line2_2_text">{items[0]?.text4}</span>

          <img className="img_line3_1" src={line3} alt="" />
          <span className="img_line3_1_text">{items[0]?.text5}</span>

          <img className="img_line3_2" src={line3} alt="" />
          <span className="img_line3_2_text">{items[0]?.text6}</span>
        </div>
      </div>
    </div>
  );
